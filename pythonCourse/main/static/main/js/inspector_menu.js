...
function getMyStatements() {
    ...
    HttpRequestPostJson('getListStatementsInspector', function (response) {
...
function createStatementFields(statement, container) {
    ...
    clickableArea.href = "inspectorstatment"; // Замените на реальный URL
